...
public sealed class ResourcePackManagementItemViewModel : ObservableObject
{
	[ObservableProperty]
	...
	public void SyncFrom(LocalResourcePack resourcePack)
	{
		...
		Subtitle = (string.Equals(resourcePack.Name, resourcePack.FileName, StringComparison.OrdinalIgnoreCase) ? null : resourcePack.FileName);
